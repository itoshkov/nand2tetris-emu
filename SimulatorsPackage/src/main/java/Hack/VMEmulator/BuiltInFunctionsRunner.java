...
public class BuiltInFunctionsRunner implements Runnable {
    ...
    private static class BuiltInToProgramRequest {
        int request;
        String details;
        short[] params;
        short returnValue;
    ...
    private static class ProgramToBuiltInRequest {
        int request;
    ...
    public void callBuiltInFunction(String functionName, short[] params) throws ProgramException {
        ...
        try {
            ...
            throw new ProgramException("Can't find " + className + ".vm or a built-in implementation for function " + methodName + " in class " + className + " taking " + params.length + " argument" + (
                    params.length == 1 ? "" : "s") + ".");
        }
        ...
        for (continueOtherThread(); programToBuiltIn.request == CALL_REQUEST;
            ...
            try { // Try to run the built-in implementation
                ...
                try {
                    ...
                    builtInToProgram.request = THROW_PROGRAM_EXCEPTION_REQUEST;
                    builtInToProgram.details = "The built-in implementation of " + functionName + " caused an exception: " + ita
                            .getTargetException()
                            .toString();
                }
            }
