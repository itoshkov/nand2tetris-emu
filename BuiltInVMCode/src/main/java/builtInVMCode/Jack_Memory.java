...
public class Jack_Memory extends JackOSClass {
    ...
    public static short peek(short address) throws TerminateVMProgramThrowable {
        return readMemory(address);
    }

    public static void poke(short address, short value) throws TerminateVMProgramThrowable {
        writeMemory(address, value);
    }

    public static short alloc(short size) throws TerminateVMProgramThrowable {
        if (size < 1)
    ...
    public static void deAlloc(short arr) throws TerminateVMProgramThrowable {
