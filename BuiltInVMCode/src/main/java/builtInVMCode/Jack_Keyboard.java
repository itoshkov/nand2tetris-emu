...
public class Jack_Keyboard extends JackOSClass {
    ...
    public static short readLine(short message) throws TerminateVMProgramThrowable {
        return javaStringToJackStringUsingVM(readLineToJavaString(message));
    }

    public static short readInt(short message) throws TerminateVMProgramThrowable {
    ...
    private static String readLineToJavaString(short message) throws TerminateVMProgramThrowable {
