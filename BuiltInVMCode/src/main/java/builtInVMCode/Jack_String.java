...
public class Jack_String extends JackOSClass {
    ...
    public static void dispose(short str) throws TerminateVMProgramThrowable {
        callFunction("Memory.deAlloc", str);
    }

    public static short length(short str) throws TerminateVMProgramThrowable {
        return readMemory(str + 1);
    }

    public static char charAt(short str, short j) throws TerminateVMProgramThrowable {
    ...
    public static void setCharAt(short str, short j, short c) throws TerminateVMProgramThrowable {
        short l = readMemory(str + 1);
        if (j < 0 || j >= l)
    ...
    public static short appendChar(short str, short c) throws TerminateVMProgramThrowable {
    ...
    public static void eraseLastChar(short str) throws TerminateVMProgramThrowable {
        short l = readMemory(str + 1);
        if (l == 0)
    ...
    public static void setInt(short str, short j) throws TerminateVMProgramThrowable {
