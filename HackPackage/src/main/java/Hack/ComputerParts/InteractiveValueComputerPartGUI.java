...
public interface InteractiveValueComputerPartGUI
 extends ValueComputerPartGUI, InteractiveComputerPartGUI {
     ...
     */
    void addListener(ComputerPartEventListener listener);

    /**
     * Un-registers the given ComputerPartEventListener from being a listener to this GUI.
     */
    void removeListener(ComputerPartEventListener listener);
     ...
     */
    void notifyListeners(int index, short value);
     ...
     */
    void setEnabledRange(int start, int end, boolean gray);
}
